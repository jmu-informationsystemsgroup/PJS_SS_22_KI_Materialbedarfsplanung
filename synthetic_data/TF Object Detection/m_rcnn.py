...
ROOT_DIR = os.path.abspath('D:/Projektseminar/PJS_SS_22_KI_Materialbedarfsplanung/synthetic_data/TF Object Detection') # **Verändert!!!** "/content/maskrcnn_colab"
...
class CustomConfig(Config):
    def __init__(self, num_classes):
        ...
        if num_classes > 1:               #**Auskommentiert**
...
class CustomDataset(utils.Dataset):
    ...
    def load_mask(self, image_id):
        ...
        for annotation in annotations:
            ...
            mask = Image.new('1', (image_info['width'], image_info['height'])) #4 vorher 1
            mask_draw = ImageDraw.ImageDraw(mask, '1')  #4 vorher 1
