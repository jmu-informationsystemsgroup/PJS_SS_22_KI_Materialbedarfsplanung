...
img = cv2.imread("F:\\Projektseminar\\Edge Detection\\Abschlussbericht\\Test.jpg")
...
cv2.imwrite("F:\\Projektseminar\\Edge Detection\\Abschlussbericht\\Canny_Resultat.jpg", imgThre) 